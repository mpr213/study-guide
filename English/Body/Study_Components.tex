\section{Study Components}
    ...
    \subsection{Study Theme Descriptions}
        ...
        \subsubsection{Theme 2: Basic Programming}
            ...
            to obain information on the various functions functions.
            ...
            The student must be able to swap 2 objects without
            destroying the name assignment. The student also has to be
            familiar with the memory model on how the name assignment
            to the objects are swapped and not over-written.
            ...
            help to obain information on the various functions and
            in-place functions.
        ...
        \subsubsection{Theme 3: Control Statements}
            ...
            syntax and indentation and be able to implement
            ...
            elif and else statements effects the program flow and
        ...
        stored by Python, in LibreOffice and visa versa.
